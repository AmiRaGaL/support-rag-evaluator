...
Support RAG Evaluator is currently a portfolio-grade full-stack RAG evaluator. This roadmap separates completed Phase 17 capabilities from intentional future work.
...
- **Real embedding provider:** Add an external embedding provider for non-demo retrieval quality experiments.
